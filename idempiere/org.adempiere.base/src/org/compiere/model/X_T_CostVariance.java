...
/** Generated Model for T_CostVariance
 *  @author iDempiere (generated) 
 *  @version Release 4.1 - $Id$ */
public class X_T_CostVariance extends PO implements I_T_CostVariance, I_Persistent 
{
    ...
    public X_T_CostVariance (Properties ctx, int T_CostVariance_ID, String trxName)
    {
      super (ctx, T_CostVariance_ID, trxName);
      /** if (T_CostVariance_ID == 0)
        {
			setC_AcctSchema_ID (0);
			setCurrentQty (Env.ZERO);
			setM_AttributeSetInstance_ID (0);
			setM_Product_ID (0);
			setT_CostVariance_ID (0);
        } */
    }

    /** Load Constructor */
    public X_T_CostVariance (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_T_CostVariance[")
	...
	/** Set CostVariance.
		@param T_CostVariance_ID CostVariance	  */
	public void setT_CostVariance_ID (int T_CostVariance_ID)
	{
		if (T_CostVariance_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_T_CostVariance_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_T_CostVariance_ID, Integer.valueOf(T_CostVariance_ID));
	}

	/** Get CostVariance.
		@return CostVariance	  */
	public int getT_CostVariance_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_T_CostVariance_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	/** Set T_CostVariance_UU.
		@param T_CostVariance_UU T_CostVariance_UU	  */
	public void setT_CostVariance_UU (String T_CostVariance_UU)
	{
		set_Value (COLUMNNAME_T_CostVariance_UU, T_CostVariance_UU);
	}

	/** Get T_CostVariance_UU.
		@return T_CostVariance_UU	  */
	public String getT_CostVariance_UU () 
	{
		return (String)get_Value(COLUMNNAME_T_CostVariance_UU);
	}
}