...
public class MOrder extends X_C_Order implements DocAction
{
	...
	public String completeIt()
	{
		...
		/**
		 * sysnova
		 * Added to check Product Material Cost during PO
		 */
		...
		for (int i = 0; i < oLines.length; i++)
		{
			...
			if(product != null && product.get_ID()>1 && product.isItem()){
				BigDecimal cost=getCurrentcost(oLine);
				if(cost.signum()!=1){
					m_processMsg = "Product Standard Cost (Cost Element=Material) Not found. PO Line No: "+ oLine.getLine()+" " + product.getValue() + "-"+product.getName();
					return DocAction.STATUS_Invalid;
				}
			}
		}
...
//	added by sysnova: Start
	...
	public BigDecimal getCurrentcost(MOrderLine line) {
		//
