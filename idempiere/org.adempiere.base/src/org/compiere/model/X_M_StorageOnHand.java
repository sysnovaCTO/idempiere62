...
public class X_M_StorageOnHand extends PO implements I_M_StorageOnHand, I_Persistent 
{
	...
	On Hand Quantity
  */
	public void setQtyNotClosing (BigDecimal QtyNotClosing)
	{
		set_ValueNoCheck (COLUMNNAME_QtyNotClosing, QtyNotClosing);
	}
	
	/** Get On Hand Quantity.
		@return On Hand Quantity
	  */
	public BigDecimal getQtyNotClosing () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_QtyNotClosing);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
