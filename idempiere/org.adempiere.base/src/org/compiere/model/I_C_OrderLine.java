...
public interface I_C_OrderLine 
{
    ...
    public static final String COLUMNNAME_NoOtherCost = "NoOtherCost";
	public void setIsNoOtherCost (boolean NoOtherCost);
	public boolean isNoOtherCost();
	
	public static final String COLUMNNAME_DutyTaxes = "DutyTaxes";
	public void setIsDutyTaxes (boolean DutyTaxes);
	public boolean isDutyTaxes();
	
	public static final String COLUMNNAME_FinancialCharge = "FinancialCharge";
	public void setIsFinancialCharge (boolean FinancialCharge);
	public boolean isFinancialCharge();
	
	public static final String COLUMNNAME_FreightInward = "FreightInward";
	public void setIsFreightInward (boolean FreightInward);
	public boolean isFreightInward();
	
	public static final String COLUMNNAME_ClearingExpence = "ClearingExpence";
