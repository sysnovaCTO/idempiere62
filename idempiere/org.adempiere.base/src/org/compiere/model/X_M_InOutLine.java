...
// 1
	...
	///sysnova added: start
	/** Set isBatchclosing.
	@param isBatchclosing 
	Optional short description of the record
  */
	/*
	public void setisBatchclosing (String isBatchclosing)
	{
		set_Value (COLUMNNAME_isBatchclosing, isBatchclosing);
	}
	public String getisBatchclosing () 
	{
		return (String)get_Value(COLUMNNAME_isBatchclosing);
	}
	*/
	/** Set Description Only.
		@param IsDescription 
		if true, the line is just description and no transaction
	  */
	public void setisBatchclosing (boolean isBatchclosing)
	{
		set_Value (COLUMNNAME_isBatchclosing, Boolean.valueOf(isBatchclosing));
	}
	
	/** Get Description Only.
		@return if true, the line is just description and no transaction
	  */
	public boolean isBatchclosing () 
	{
		Object oo = get_Value(COLUMNNAME_isBatchclosing);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
