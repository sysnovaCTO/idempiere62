...
// @SQL=SELECT NVL(MAX(SeqNo),0)+10 AS DefaultValue FROM M_DiscountSchemaBreak WHERE M_DiscountSchema_ID=@M_DiscountSchema_ID@
  ...
  //Muntasim 281208
  	///////////////////////////// 
  	/** Set Percent based.
  	@param IsPercentBased 
  	 discount   based on Percent
  	*/
  	public void setIsPercentBased (boolean IsPercentBased)
  	{
  	set_Value (COLUMNNAME_IsPercentBased, Boolean.valueOf(IsPercentBased));
  	}

  	/** Get Percent based.
  	@return  discount   based on Percent
  	*/
  	public boolean isPercentBased () 
  	{
  	Object oo = get_Value(COLUMNNAME_IsPercentBased);
  	if (oo != null) 
  	{
  		 if (oo instanceof Boolean) 
  			 return ((Boolean)oo).booleanValue(); 
    ...
    //sysnova 24-04-2014
  	///////////////////////////// 
  	/** Set ProductBased based.
  	@param IsPercentBased 
  	 discount   based on Product
  	*/
  	public void setIsProductBased (boolean IsProductBased)
  	{
  	set_Value (COLUMNNAME_IsProductBased, Boolean.valueOf(IsProductBased));
  	}
  	...
  	*/
  	...
  	{
  	Object oo = get_Value(COLUMNNAME_IsProductBased);
  	if (oo != null) 
  	{
  		 if (oo instanceof Boolean) 
  			 return ((Boolean)oo).booleanValue(); 
