...
// 1
	...
	public void setIsNoOtherCost (boolean NoOtherCost)
	{
		set_Value (COLUMNNAME_NoOtherCost, Boolean.valueOf(NoOtherCost));
	}

	public boolean isNoOtherCost () 
	{
		Object oo = get_Value(COLUMNNAME_NoOtherCost);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	public void setIsDutyTaxes (boolean DutyTaxes)
	{
		set_Value (COLUMNNAME_DutyTaxes, Boolean.valueOf(DutyTaxes));
	}

	public boolean isDutyTaxes () 
	{
		Object oo = get_Value(COLUMNNAME_DutyTaxes);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	public void setIsFinancialCharge (boolean FinancialCharge)
	{
		set_Value (COLUMNNAME_FinancialCharge, Boolean.valueOf(FinancialCharge));
	}

	public boolean isFinancialCharge () 
	{
		Object oo = get_Value(COLUMNNAME_FinancialCharge);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	public void setIsFreightInward (boolean FreightInward)
	{
		set_Value (COLUMNNAME_FreightInward, Boolean.valueOf(FreightInward));
	}

	public boolean isFreightInward () 
	{
		Object oo = get_Value(COLUMNNAME_FreightInward);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	public void setIsClearingExpence (boolean ClearingExpence)
	{
		set_Value (COLUMNNAME_ClearingExpence, Boolean.valueOf(ClearingExpence));
	}

	public boolean isClearingExpence () 
	{
		Object oo = get_Value(COLUMNNAME_ClearingExpence);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
